          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-charcoal">Building</span>
                <br />
                <span className="text-brand-primary">Businesses.</span>
                <br />
                <span className="text-charcoal">Scaling</span>
                <br />
                <span className="text-brand-primary">Brands.</span>
              </h1>

              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                We help businesses attract attention, build trust, and generate
                consistent growth through strategic content, branding,
                commercial video production, and social media marketing.
              </p>

              <p className="text-gray-500 italic border-l-4 border-brand-primary pl-4">
                At ASCEND, we don't just create content-we build marketing
                systems that position your business, attract customers, and
